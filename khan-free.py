...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;37m[\033[1;32mfoysal-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36m foysal PROCESS HAS BEEN STARTED')
...
=================================================
    ...
    [-] AUTHOR    :\033[1;32m Foysal-khan

    [-] GITHUB    :\033[1;32m Foysal-100

    [-] WhatsApp  :\033[1;32m 01854521971
